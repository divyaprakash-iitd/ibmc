...
OBJECTS= ibmc.o mod_pressure.o mod_amgx.o ftn_c.o mod_dims.o mod_mesh.o mod_time.o mod_boundary.o mod_time_stepping.o mod_io.o mod_particle.o mod_ib.o mod_vec.o mod_ibm.o mod_cilia.o mod_cilia_array.o mod_closed_cilia.o
...
mod_closed_cilia.o: mod_closed_cilia.f90 mod_mesh.o mod_ib.o mod_vec.o mod_cilia.o Makefile
	$(FORT) -c $<
